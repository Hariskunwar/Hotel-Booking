...
const AddRoom = () => {
  ...
  return (
   <form>
      <Title align="left" font="outfit" title="Add Room" subTitle="Fill the details carefull and accurate room details, pricing and amenities to enhance the user booking experience." />
      {/*Upload Images */}
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
            ...
            <select id={setInputs.roomType} onChange={(e)=>setInputs({...inputs,roomType:e.target.value})} className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full' >
        ...
        <div>
            ...
            <input className='border border-gray-300 mt-1 rounded p-2 w-24' type="number" value={inputs.pricePerNight} onChange={(e)=>setInputs({...inputs,pricePerNight:e.target.value})}/>
